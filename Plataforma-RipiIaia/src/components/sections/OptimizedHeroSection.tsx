...
const HeroSection = () => {
  ...
  return (
    <section className="relative py-8 px-4 bg-gradient-to-br from-transparent via-transparent to-raiz/100 text-gray-200 min-h-screen flex flex-col">
      {/* Fundo abstrato com imagem da floresta */}
      <div className="absolute inset-0 z-0 opacity-85">
        {/* Usando OptimizedImage para a imagem de fundo */}
        <div 
        ...
        >
          <OptimizedImage
            ...
            loading="eager" // Carrega com prioridade por ser elemento crítico
            sizes="100vw" // Imagem de fundo ocupa toda a largura
          />
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="w-full flex flex-col items-center mb-2 md:mb-4">
            <div className="bg-profundo/40 backdrop-blur-sm p-3 md:p-4 rounded-xl border-2 border-celestial/40 shadow-md mb-2">
              {/* Logo otimizado com OptimizedImage */}
              <OptimizedImage
                src="ripi3.png"
                alt="Logo Ripi Iaiá"
                className="h-16 md:h-20 lg:h-24 transition-all duration-300 hover:scale-105"
                loading="eager" // Logo é crítico, deve carregar rapidamente
          ...
          {/* Player de vídeo em grande destaque usando LazyVideo */}
          <div
          ...
          >
            <LazyVideo
              src="MANAUS AMAZONIA3.mp4"
              poster="floresta2.jpg"
