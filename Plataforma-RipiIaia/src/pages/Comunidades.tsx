...
const HeroSection = () => (
  <section className="py-14 md:py-20 text-center bg-primary-50">
    <div className="container mx-auto max-w-3xl flex flex-col items-center gap-6">
      <Users className="w-16 h-16 text-primary-500 mb-2" />
      <h1 className="text-4xl md:text-6xl font-extrabold text-primary-800 mb-2">
        Conecte-se com Nossas Comunidades
      </h1>
      <p className="text-lg md:text-2xl text-primary-700 mb-4">
        Explore a diversidade de portais, tradições, artistas e iniciativas que formam o vibrante Universo Daime.
      </p>
      <Button size="lg" className="bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-xl shadow-md text-lg">
        Explorar Conexões
      </Button>
    </div>
  </section>
  ...
  return (
    <section className="py-10 md:py-16 bg-slate-50">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 text-primary-600">Músicos & Produtores em Destaque</h2>
              ...
              <Card className="bg-white border border-slate-200 ring-1 ring-slate-200 shadow-sm group overflow-hidden relative w-full max-w-xs h-[350px]">
                ...
                <div className="relative z-10 pt-36 px-4 pb-4 flex flex-col h-full bg-gradient-to-t from-white/80 to-transparent">
                  <CardHeader className="p-0 mb-2">
                    ...
                    <Badge className="bg-primary-100 text-primary-700 border border-primary-300 mb-2">{item.type}</Badge>
...
const PortalGrid = () => (
  <section id="portais" className="py-10 md:py-16 bg-white">
    <div className="container mx-auto max-w-6xl">
      <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12 text-primary-600">Portais e Conexões da Comunidade</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {[...plataformas, ...subdominios].map((item, index) => (
          <Card key={index} className={"bg-white border border-slate-200 hover:border-primary-600 transition-all duration-300 group overflow-hidden relative shadow-sm"}>
            ...
            <div className="relative z-10 pt-36 md:pt-40 px-4 pb-4 flex flex-col h-full bg-gradient-to-t from-white/80 to-transparent">
              <CardHeader className="p-0 mb-2 flex-grow-0">
                <div className="flex justify-between items-start">
                  <CardTitle className="text-xl md:text-2xl group-hover:text-primary-600 transition-colors text-slate-800 font-bold">{item.title}</CardTitle>
                  <Badge className="bg-primary-100 text-primary-700 border border-primary-300 text-xs md:text-sm">{item.type}</Badge>
                </div>
              ...
              <CardContent className="p-0 mt-auto flex-grow-0">
                <Button asChild className="w-full bg-primary-600 hover:bg-primary-700 text-white mt-4">
...
const TradicoesSection = () => (
  <section id="tradicoes" className="py-12 md:py-16 bg-slate-50 rounded-xl border border-slate-200 mt-10 md:mt-16 mx-4">
    <div className="container mx-auto text-center max-w-4xl">
      <h3 className="text-2xl md:text-3xl font-bold mb-6 text-primary-600">Tradições Respeitadas</h3>
      ...
      <div className="flex flex-wrap justify-center gap-6 md:gap-8">
        {tradicoes.map((tradicao) => (
          <div key={tradicao} className="flex flex-col items-center text-center group w-28 md:w-32 p-2 rounded-lg hover:bg-slate-100 transition-colors duration-300">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-3 border border-primary-300 group-hover:border-primary-500 transition-colors duration-300 shadow-sm">
              <Sprout className="w-8 h-8 md:w-10 md:h-10 text-primary-600 group-hover:text-primary-500 transition-colors" />
            </div>
